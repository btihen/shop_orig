class CreateTaxCategories < ActiveRecord::Migration[5.1]
  def change
    create_table :tax_categories do |t|
      ...
      t.jsonb    :tax_category_info, null: false, default: '{}'
    ...
    add_index :tax_categories, :tax_category_info,  using: :gin
    # add_index :tax_categories, [:tax_category_name, :tax_category_info, :tax_start_date],
    #                                unique: true,

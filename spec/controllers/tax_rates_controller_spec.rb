...
RSpec.describe TaxRatesController, type: :controller do
  ...
  # TaxRatesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TaxRate" do
        expect {
          post :create, params: {tax_rate: valid_attributes}, session: valid_session
        }.to change(TaxRate, :count).by(1)
      end

      it "redirects to the created tax_rate" do
        post :create, params: {tax_rate: valid_attributes}, session: valid_session
        expect(response).to redirect_to(TaxRate.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the tax_rate" do
        tax_rate = TaxRate.create! valid_attributes
        put :update, params: {id: tax_rate.to_param, tax_rate: valid_attributes}, session: valid_session
        expect(response).to redirect_to(tax_rate)
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested tax_rate" do
      tax_rate = TaxRate.create! valid_attributes
      expect {
        delete :destroy, params: {id: tax_rate.to_param}, session: valid_session
      }.to change(TaxRate, :count).by(-1)
    end
    ...
    it "redirects to the tax_rates list" do
      tax_rate = TaxRate.create! valid_attributes
      delete :destroy, params: {id: tax_rate.to_param}, session: valid_session
      expect(response).to redirect_to(tax_rates_url)
    end
  end

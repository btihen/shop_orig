...
RSpec.describe RegistersController, type: :controller do
  ...
  let(:valid_attributes) { FactoryBot.build(:register).attributes }

  let(:invalid_attributes) { FactoryBot.build(:invalid_register).attributes }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested register" do
      register = Register.create! valid_attributes
      expect {
        delete :destroy,  params: {id: register.to_param},
                          session: valid_session
      }.to change(Register, :count).by(-1)
    end

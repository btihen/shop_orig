...
RSpec.describe ProductsController, type: :controller do
  ...
  let(:invalid_attributes) { FactoryBot.build(:invalid_product).attributes }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) { {product_description: "Om Mani Padme Hum"} }
      ...
      it "updates the requested product" do
        ...
        put :update, params: {id: product.to_param,
                    ...
                    session: valid_session
        product.reload
        expect( product.product_description ).to eq( "Om Mani Padme Hum" )
      end

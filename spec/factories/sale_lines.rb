FactoryBot.define do
  factory :sale_line do
    ...
    sale_line_sale_price_cents    { Faker::Commerce.price * 100 }
    sale_line_sale_price_currency { ApplicationHelper::REGISTER_CURRENCIES.sample }
  ...
  factory :invalid_nil_sale_line, parent: :sale_line do
    ...
    sale_line_sale_price_cents    { nil }
    # sale_line_sale_price          { Money.new(nil, nil) }
  end
  factory :invalid_neg_sale_line, parent: :sale_line do
    sale                     { nil }
    stock_item               { nil }
    sale_line_quantity       { -1 }
    sale_line_sale_price_cents    { -1000 }
    sale_line_sale_price_currency { nil }
    # sale_line_sale_price          { Money.new(-100, nil ) }
  end
end
